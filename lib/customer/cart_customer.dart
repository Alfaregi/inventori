...
class CartPage extends StatefulWidget {
  ...
  static void addToCart(Product product, int quantity) {
    ...
    final existingItem =
        cartItems.where((item) => item.productId == product.productId).toList();
    ...
    if (existingItem.isNotEmpty) {
      ...
      cartItems.add(CartItem(
        productId: product.productId, // Add product_id parameter
        name: product.name,
        price: product.price,
        quantity: quantity,
...
class CartItem {
  ...
  String get product_id => productId.toString(); // Return product_id as string
}
