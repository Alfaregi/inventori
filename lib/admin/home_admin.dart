      ...
      child: Column(  
        ...
        children: [  
          Row(  
            ...
            children: [  
              StatCard(label: 'Total Products', value: products.length.toString(), color: Colors.pink),  
          ...
          SizedBox(height: 20),  
          Text('Available Products', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),  
          Expanded(  
            child: RefreshIndicator(  
              ...
              child: products.isNotEmpty  
                        ...
                        return ProductListItem(  
                          ...
                          onTap: () {  
                            ...
                            Navigator.push(  
                              context,  
                              MaterialPageRoute(  
                                builder: (context) => UpdateProductPage1(product: products[index]), // Pass the selected product  
                              ),  
                            ).then((_) {  
                  ...
                  : Center(child: Text('No products available', style: TextStyle(fontSize: 18))),  
            ),  
          ),  
        ],  
      ),  
  ...
  Widget build(BuildContext context) {  
    ...
    return Card(  
      ...
      child: ListTile(  
        ...
        title: Text(product.name.isNotEmpty ? product.name : 'No Name', style: TextStyle(fontWeight: FontWeight.bold)),  
        subtitle: Text(product.description, style: TextStyle(color: Colors.black54)), // Display description  
        trailing: Text('Qty ${product.quantity}', style: TextStyle(color: Colors.green)),  
